					...
					@foreach ($assessments as $assessment)
						<article class="postcard light blue">
							<a class="postcard__img_link" href="{{ route('public.assessment', $assessment->uuid) }}">
								<img class="postcard__img" src="{{ $assessment->cover ? asset('storage/uploads/covers/' . $assessment->cover) : asset('images/default/assessment.jpg') }}" alt="Image Title" />
							</a>
							<div class="postcard__text t-dark">
								<h1 class="postcard__title blue">
									<a href="{{ route('public.assessment', ['assessment' => $assessment->uuid, 'nisn' => request('nisn')]) }}">{{ $assessment->title }}</a>
								</h1>
								<div class="postcard__subtitle small">
									<time datetime="{{ $assessment->updated_at->toDateString() }}">
										{{ $assessment->updated_at->translatedFormat('l, j F Y') }}
									</time>
								</div>
